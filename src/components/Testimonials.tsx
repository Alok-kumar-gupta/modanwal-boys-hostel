...
// Default seed array kept empty so only genuine user-submitted reviews appear
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                      ...
                      <div className="md:col-span-6 space-y-4">
                        ...
                        <div>
                          ...
                          <input
                            type="text"
                            placeholder="College / Degree or Exam"
                            value={formCollege}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <input
                              type="text"
                              placeholder="Duration / Academic Year"
                              value={formYear}
          ...
          <AnimatePresence mode="popLayout">
            ...
            >
              {filteredTestimonials.length === 0 ? (
                <div className="col-span-full bg-white border border-slate-200 rounded-3xl p-10 sm:p-12 text-center space-y-4 shadow-xs">
                  <div className="w-12 h-12 bg-slate-100 rounded-full flex items-center justify-center mx-auto text-slate-400">
                    <Star className="w-6 h-6 text-slate-400" />
                  </div>
                  <div className="space-y-1">
                    <h5 className="font-display font-bold text-base text-slate-800">No Student Reviews Yet</h5>
                    <p className="text-xs text-slate-500 max-w-md mx-auto">
                      All sample records have been cleared. As residents and students share their experience, genuine verified reviews will appear here.
                    </p>
                  </div>
                  <button
                    onClick={() => setIsFormOpen(true)}
                    className="px-5 py-2 bg-slate-900 text-white rounded-full text-xs font-bold cursor-pointer hover:bg-slate-800 transition-all shadow-3xs"
                  >
                    Write First Review
                  </button>
                </div>
