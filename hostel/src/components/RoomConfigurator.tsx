...
export default function RoomConfigurator({ onPreConfigure, config }: RoomConfiguratorProps) {
  ...
  const addonOptions = [
    { id: 'cooler', name: 'Desert Air Cooler (for Summer)', price: config.coolerPrice ?? 500, desc: 'High airflow cooler for summer focus' },
    { id: 'laundry', name: 'Housekeeping Laundry Care', price: config.laundryPrice ?? 400, desc: 'House staff washes & folds twice a week' },
    { id: 'chair', name: 'Ergonomic Desk Chair Upgrade', price: config.chairPrice ?? 150, desc: 'Enhanced orthopaedic study seat' },
    { id: 'locker', name: 'Private Secured Iron Locker', price: config.lockerPrice ?? 100, desc: 'Robust digital safe drawer' },
  ];
            ...
            <div className="pt-4 border-t border-slate-100 space-y-2">
              <form onSubmit={handleApplyCoupon} className="flex items-center gap-3">
                <div className="flex-1">
                  <input
                    type="text"
                    placeholder="Have coupon? Try 'SRMUFIRST'"
                    value={couponCode}
