      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative" id="hero-right">
            ...
            {/* Small Floating review overlay */}
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6, delay: 0.4 }}
              className="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-md border border-slate-100 flex items-center gap-3 max-w-xs"
              id="hero-floating-review"
            >
              <div className="w-10 h-10 rounded-full bg-slate-900 text-white flex items-center justify-center font-bold font-sans text-sm shadow-sm">
                SRM
              </div>
              <div>
                <p className="text-xs font-bold text-slate-800">"Super Close & Affordable!"</p>
                <p className="text-[10px] text-slate-500">Alok, B.Tech CSE (3rd Year)</p>
              </div>
            </motion.div>
          </div>
        </div>
