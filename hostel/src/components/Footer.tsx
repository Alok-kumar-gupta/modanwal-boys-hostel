...
import { Shield, Phone, Mail, MapPin, Compass, ShieldCheck } from 'lucide-react';
...
export default function Footer({ config, onOwnerClick }: FooterProps) {
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <div className="flex flex-col gap-2.5 text-sm">
              {[
                ...
                { name: 'Interactive Virtual Tour', id: '#tour' },
